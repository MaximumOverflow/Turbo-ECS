...
lazy_static! {
    ...
    static ref PTR_TO_QUERY: Mutex<HashMap<(usize, usize), EntityQuery>> = Mutex::new(HashMap::default());
    static ref TYPE_TO_QUERY: Mutex<HashMap<TypeId, EntityQuery, Hasher>> = Mutex::new(HashMap::default());
}
...
impl EntityQueryData {
    pub fn include(&self) -> &BitField { &self.include }
...
#[inline(never)]
fn create_query<
    I: 'static + ComponentSet,
    E: 'static + ComponentSet,
>(key: TypeId, ttq: &mut HashMap<TypeId, EntityQuery, Hasher>) -> EntityQuery {
